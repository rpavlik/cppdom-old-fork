...
# OS_ABI          - Default Application Binary Interface for Linux.
# OS_ISA          - Default Instruction Set Architecture for Linux.
# OS_ABI_FLAGS    - ABI flags for Linux object files, libraries and binaries.
# OS_LIBS_BEGIN   - Linux-specific options that need to go at the start of the
#                   linker's list of libraries and associated options.
# OS_LIBS_END     - Linux-specific options that need to go at the end of the
#                   linker's list of libraries and associated options.
# OS_SYS_LIBS     - Any extra Linux-specific system libraries that are needed.
...
#
# OS_CFLAGS       - Linux-specific C compiler options.
# OS_CXXFLAGS     - Linux-specific C++ compiler options.
# OS_DEBUG_FLAGS  - Linux-speicfic compiler debugging flags.
# OS_ARFLAGS      - Linux-specific archiver options.
# OS_LDFLAGS      - Linux-specific linker options.
# OS_INCLUDES     - Linux-specific include paths.
# OS_OPTIM_FLAGS  - Linux-specific compiler optimization flags.
# -----------------------------------------------------------------------------
